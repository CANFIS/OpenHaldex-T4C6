...
// Only executed when in modes: FWD/5050/7525/CUSTOM
float get_lock_target_adjustment()
{
  // Handle FWD/5050/7525.
  switch (state.mode)
  {
    case MODE_FWD:
      return 0;
  ...
  // Getting here means it's in CUSTOM.
...
void get_lock_data(CAN_message_t &frame)
{
  ...
  // Edit the frames if configured as Gen2 (copied from Gen4).
